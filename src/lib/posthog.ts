...
//
// analytics.ts의 AnalyticsAdapter를 구현해 trackEvent() 이벤트를 PostHog로
// 흘려보낸다. 화면 코드는 전혀 바뀌지 않는다 — main.tsx에서 registerAdapter로
// 이 어댑터를 붙이기만 하면 된다.
//
...
import type { AnalyticsAdapter, TrackedEvent } from "./analytics";
