// Odday 사용자 흐름 오케스트레이션. (MVP 문서 섹션 8)
// 스텝 전환 지점에서 대응 이벤트를 trackEvent로 발생시킨다.
//
// 여러 엔티티(quest, record)에 걸친 앱 전역 흐름이므로 app 레이어에 둔다.
// (FSD의 deprecated된 processes 영역 → app/features로 분산 권고)

import { useCallback, useEffect, useState } from "react";
import type { Dispatch, SetStateAction } from "react";
import type { ContextSelection, Quest } from "@/entities/quest";
import { getQuestById, pickQuests } from "@/entities/quest";
import { addRecord } from "@/entities/record";
import { trackEvent } from "@/shared/lib/analytics";
import type { FeedbackDraft, FeedbackInput } from "@/pages/feedback";
import { EMPTY_FEEDBACK_DRAFT } from "@/pages/feedback";
